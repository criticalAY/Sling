...
object Constants {
     ...
     */
    val ANKI_TIME_CATEGORY: Category = Category.create(Category.CORRECTNESS, "AnkiTime", 10)
    ...
    val ANKI_CROWDIN_CATEGORY: Category =
        Category.create(Category.CORRECTNESS, "AnkiCrowdIn", ANKI_CROWDIN_PRIORITY)
     ...
     */
    val ANKI_CODE_STYLE_CATEGORY: Category = Category.create(Category.COMPLIANCE, "CodeStyle", 10)
     ...
     * sub category for [Category.CORRECTNESS].
     */
    val ANKI_XML_CATEGORY: Category = Category.create(Category.CORRECTNESS, "XML", 10)
