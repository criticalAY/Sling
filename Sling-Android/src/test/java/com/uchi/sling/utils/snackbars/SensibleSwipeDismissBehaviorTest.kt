...
package com.uchi.sling.utils.snackbars
...
internal class SensibleSwipeDismissBehaviorTest {
    ...
    @Test
    fun `Stationary snackbar isn't dismissed if it hasn't traveled`() {
        assertEquals(Dismiss.DoNotDismiss, behavior.shouldDismiss(snackbar, 0f))
    }

    @Test
    fun `Stationary snackbar isn't dismissed if it hasn't traveled far`() {
    ...
    @Test
    fun `Stationary snackbar is dismissed if it has traveled far`() {
    ...
    @Test
    fun `Moving snackbar isn't dismissed if it hasn't traveled far and is moving slowly`() {
    ...
    @Test
    fun `Moving snackbar isn't dismissed if it has traveled far, but is moving slowly towards initial position`() {
        positionSnackbarAtX(+80)
        assertEquals(Dismiss.DoNotDismiss, behavior.shouldDismiss(snackbar, -100f))
    ...
    @Test
    fun `Moving snackbar is dismissed if it has traveled far and is moving towards the closest edge, even if slowly`() {
        positionSnackbarAtX(+80)
    ...
    @Test
    fun `Moving snackbar is dismissed if it is moving fast`() {
